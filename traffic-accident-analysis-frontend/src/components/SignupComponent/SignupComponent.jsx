    ...
    <main className={styles.container}>
      ...
      <p className={errorData.message ? styles["error", "signinError"]: styles.hidden}>{errorData.message}</p>
        ...
        <div className={styles.formControl}>
          ...
          <p className={errors.email ? styles.error : styles.hidden}>* {errors.email?.message}</p>
        </div>
        ...
        <div className={styles.formControl}>
          ...
          <p className={errors.confirmPassword ? styles.error : styles.hidden}>* {errors.confirmPassword?.message}</p>
        </div>

        <button type="submit">Sign up</button>
        <p>Already have an account? <a onClick={() => navigator("/")}>Sign in</a></p>
      </form>
    </main>
  )
}
